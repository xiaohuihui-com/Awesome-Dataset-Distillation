...
from .dataloader import transform_mnist, transform_fashion, transform_cifar, transform_svhn, transform_imagenet, \
    TensorDataset, MultiEpochsDataLoader
...
class Synthesizer():
    ...
    def test(self, args, model, val_loader, nclass,
        ...
        test_data(args, model, loader, val_loader, nclass,
                  criterion,
                  optimizer,
                  scheduler,
